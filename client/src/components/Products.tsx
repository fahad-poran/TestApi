...
const Products = () => {
  ...
  const [newProduct, setNewProduct] = useState({ name: '', price: 0, description: '', categoryId: 0, initialStock: 0 });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewProduct({ name: '', price: 0, description: '', categoryId: 0, initialStock: 0 });
      setEditingId(null);
      fetchData();
    } catch (err) {
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
          <span className="text-4xl">📦</span> Products Management
        </h1>
